export const categoriesData: Array<{ [key: string]: { name: string; icon: string }[] }> = [
  {
    languages: [
      {
        name: "TypeScript",
      ...
      {
        name: "Objective-C",
        icon: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/objectivec/objectivec-plain.svg"
      },
      {
        name: "R",
